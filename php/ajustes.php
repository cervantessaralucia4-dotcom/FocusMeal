  ...
  <div class="stats">
    ...
    <div class="card" style="flex:1; min-width:300px">
      ...
      <form method="POST" action="ajustes.php">
        ...
        <label>Edad</label>
        <input type="number" name="edad" min="1" max="120" value="<?= $usuario['edad'] ?>">
        ...
        <input type="number" name="peso_actual" step="0.1" min="1" value="<?= $usuario['peso_actual'] ?>">

        <label>Altura (cm)</label>
        <input type="number" name="altura" step="0.1" min="1" value="<?= $usuario['altura'] ?>">
    ...
    <div class="card" style="flex:1; min-width:280px">
      ...
      <form method="POST" action="ajustes.php">
        ...
        <input type="password" name="contrasena_nueva" minlength="8" required>
